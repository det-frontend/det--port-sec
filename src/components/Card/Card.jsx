...
const Card = ({ title, subtitle, id, img, delay }) => {
  return (
    ...
    //       <div className="text-md text-text/80 ">
    //         {subtitle.slice(0, 110)}{" "}
    //         <span className="text-text/30"> learn more ...</span>
    //       </div>
    //     </div>
    //     {/* <div className="bg-button hover:bg-transparent duration-100 mt-2 hover:text-button border-2 border-button px-4 py-2 ms-auto flex rounded-md text-white">
    //         Learn more
    //       </div> */}
    //     <button className="button-sm ms-auto flex">Learn more</button>
    //   </div>
    // </motion.div>
    <motion.div
      whileHover={{
